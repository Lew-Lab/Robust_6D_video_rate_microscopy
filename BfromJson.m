...
<<<<<<< Updated upstream
save(['B_ZScanned_zf' num2str(systemPar.zf*1e9) '_PSFsz' num2str(systemPar.PSFsz)],'Bstruct','systemPar','-v7.3');
=======
save(['psf' filesep 'B_ZScanned_zf1200_' num2str(systemPar.PSFsz)],'Bstruct','systemPar');
>>>>>>> Stashed changes
