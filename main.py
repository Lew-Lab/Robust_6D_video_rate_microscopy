...
### document setup ###
psf_file = 'planar_MVR' # channel number x orientation x Z x X x Y
...
### object domain ###
object = 100*loadmat(os.path.join('object_plane', object_file+'.mat'))['object']
...
plot.plot_img(img_iso, '(Bxx+Byy+Bzz)/3 convolve with (mxx+myy+mzz)')
...
# plot.plot_obj_voxel(obj_est,'z',0.3,'Estimation of circle')
# plot.plot_obj_voxel(obj_est,'z',0.9,'Estimation of circle')
